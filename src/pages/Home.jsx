  ...
  return (
    ...
    <div className="doctor-card">
        <img src="/doc.jpg" className="doc-img"></img>
            ...
            <p className="value">Dr. Cristian Yazir Medina</p>
    ...
    {/*<div className="testimonials-section">
        <h2>Sobre Mc. Pie</h2>
        <p className="subtitle">En Mc. Pie, nos especializamos en el cuidado integral de los pies y el andar. Nuestro objetivo es proporcionar alivio y mejorar la calidad de vida de nuestros pacientes a través de tratamientos personalizados y atención profesional.</p>
        <p className="subtitle">Nuestro equipo está liderado por el Dr. Cristian Yazir Medina, un podólogo clínico con amplia experiencia en el diagnóstico y tratamiento de diversas afecciones podológicas. Utilizamos tecnología avanzada y técnicas innovadoras para garantizar resultados efectivos y duraderos.</p>
        <p className="subtitle">Ya sea que estés lidiando con dolor en los pies, problemas de postura o cualquier otra molestia relacionada con las extremidades inferiores, en Mc. Pie estamos aquí para ayudarte a recuperar tu bienestar y movilidad.</p>
    </div>*/}
